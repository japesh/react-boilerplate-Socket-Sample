"use strict";
  ...
  TradingView.ChatWidgetEmbed.prototype = {
    createWidget: function () {
      ...
      var query = "&" + TradingView.createUrlParams({whotrades: this.options.whotrades, locale: this.options.locale});
      var utm = TradingView.generateUtmForUrlParams(this.options, {type: "UserInfoWidget"});
  ...
  TradingView.EventsWidget.prototype = {
    createWidget: function () {
      ...
      var query = TradingView.createUrlParams({currency: this.options.currency, importance: this.options.importance});
    ...
    return function (target, client_id) {
      ...
      return {
        on: function (name, callback, keepPrevious) {
          ...
          var msg = {id: call_id++, type: "get", name: name, client_id: client_id, data: data, provider: provider_id};
